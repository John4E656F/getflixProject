...
const Signup = (props) => {
  ...
  if ((!form.repeatPassword.valid && form.repeatPassword.touched) || (form.onSubmitInvalid && !form.repeatPassword.valid)) {
  ...
  async function formSubmitHandler(event) {
    ...
    if (!form.email.valid || !form.password.valid) {
      ...
      axios
        // .post('https://aniflix-getflix.herokuapp.com/user/signup', newUser)
