...
Anilist.media.anime(21708).then(data => {
    console.log(data);
					...
					<h2>Documentation</h2>
					<p>
						Documentation is provided in two locations. A static HTML site is avalible with the package
					...
					<p>
						Please refer to the
						<a href="https://github.com/Butterstroke/AniList-Node/tree/master/.github/CONTRIBUTING.md"
					...
					<p>
						...
						<a href="https://github.com/Butterstroke/AniList-Node/issues">GitHub repository</a>. For other
						needs, either contact me by email
						<a href="mailto:katsurinstudios@protonmail.ch">katsurinstudios@protonmail.ch</a> or in my
