		...
		<div id="main">
			...
			<section>
				...
				<article>
					<h2>How to Import</h2>
					<p>
						AniList-Node is a class based, asyncronous package, meaning the main class needed to be
...
const anilist = new AniList();
					...
					<p>
						...
						should be imported as directed below.
					</p>
					<pre class="prettyprint source lang-TypeScript"><code>import AniList from &quot;anilist-node&quot;;
