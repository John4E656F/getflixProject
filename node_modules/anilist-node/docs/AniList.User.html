		...
		<div id="main">
			...
			<section>
				...
				<article>
					...
					<div class="description usertext">Fetch a user's AniList profile, basic and stats.</div>
					...
					<h4 class="name" id="follow">
						<span class="type-signature">(async) </span>follow<span class="signature">(userID)</span
					...
					<div class="description usertext">[Requires Login] Follow/Unfollow a user</div>
					...
					<div class="description usertext">Fetch profile information on the currently authorized user.</div>
					...
					<div class="description usertext">Fetch recent activity from a user.</div>
					...
					<div class="description usertext">Fetch a user's AniList basic profile.</div>
					...
					<div class="description usertext">Fetch a user's AniList stats.</div>
					...
					<div class="description usertext">[Requires Login] Update user settings</div>
