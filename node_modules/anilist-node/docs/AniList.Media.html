		...
		<div id="main">
			...
			<section>
				...
				<article>
					...
					<div class="description usertext">Fetch an anime entry by its AniList ID.</div>
					...
					<h4 class="name" id="favouriteAnime">
						<span class="type-signature">(async) </span>favouriteAnime<span class="signature">(id)</span
					...
					<div class="description usertext">[Requires Login] Favourite/Unfavourite an anime</div>
					...
					<h4 class="name" id="favouriteManga">
						<span class="type-signature">(async) </span>favouriteManga<span class="signature">(id)</span
						><span class="type-signature"> &rarr; {Boolean}</span>
					</h4>
					...
					<div class="description usertext">[Requires Login] Favourite/Unfavourite a manga</div>
					...
					<div class="description usertext">Fetch a manga entry by its AniList ID.</div>
