		...
		<div id="main">
			...
			<section>
				...
				<article>
					...
					<div class="description usertext">[Require Login] Delete a thread</div>
					...
					<div class="description usertext">Get a specific thread by its AniList ID</div>
					...
					<div class="description usertext">Get thread comments for a thread</div>
