			...
			<section>
				...
				<article>
					...
					<h4 class="name" id="favouriteStudio">
						<span class="type-signature">(async) </span>favouriteStudio<span class="signature">(id)</span
					...
					<div class="description usertext">[Requires Login] Favourite/Unfavourite a studio</div>
					...
					<div class="description usertext">Grabs all possible genres</div>
					...
					<div class="description usertext">Grabs all possible media tags</div>
					...
					<div class="description usertext">Searches AniList based on a specific term.</div>
					...
					<div class="description usertext">Grabs data on a studio</div>
